  ...
  return (
   <ScrollView style={styles.container1}>
        ...
        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>1. Horas em Espanhol</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>2. Verbos Irregulares em Espanhol</Text>
        </TouchableOpacity>

         <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>3. Dias da Semana em Espanhol</Text>
        </TouchableOpacity>
