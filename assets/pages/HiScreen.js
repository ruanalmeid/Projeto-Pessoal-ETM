  ...
  return (
   <ScrollView style={styles.container1}>
        ...
        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>1. Guerra do Paraguai</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>2. Colonia de Exploração</Text>
        </TouchableOpacity>

         <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>3. Origem do ser humano</Text>
        </TouchableOpacity>

         <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>4. Revolução Francesa</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>5. Feudalismo</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>6. Merncantilismo</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>7. Carta Magna</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={redirecionar}>
          <Text style={styles.buttonCont}>8. Teoria Criacionista</Text>
        </TouchableOpacity>
